...
CREATE TABLE facultad_tecnologica.administrativo (
...
CREATE TABLE facultad_tecnologica.programa_asignatura (
...
CREATE TABLE facultad_tecnologica.pre_requisito (
    ...
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_tecnologica.programa_asignatura(id_programa_asignatura,id_facultad),
    FOREIGN KEY(id_programa_asignatura_requisito,id_facultad) REFERENCES facultad_tecnologica.programa_asignatura(id_programa_asignatura,id_facultad)
);

CREATE TABLE facultad_tecnologica.grupo (
    ...
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_tecnologica.programa_asignatura(id_programa_asignatura,id_facultad),
    FOREIGN KEY(id_profesor) REFERENCES facultad_tecnologica.profesor(id_profesor)
);

CREATE TABLE facultad_tecnologica.matricula (
    ...
    FOREIGN KEY(id_estudiante) REFERENCES facultad_tecnologica.estudiante(id_estudiante)
);

CREATE TABLE facultad_tecnologica.inscripcion (
    ...
    FOREIGN KEY(id_grupo,id_facultad) REFERENCES facultad_tecnologica.grupo(id_grupo,id_facultad),
    FOREIGN KEY(id_estudiante) REFERENCES facultad_tecnologica.estudiante(id_estudiante)
);

CREATE TABLE facultad_tecnologica.homologacion (
    ...
    FOREIGN KEY(id_profesor_evaluador) REFERENCES facultad_tecnologica.profesor(id_profesor),
    FOREIGN KEY(id_estudiante) REFERENCES facultad_tecnologica.estudiante(id_estudiante),
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_tecnologica.programa_asignatura(id_programa_asignatura,id_facultad)
);

CREATE TABLE facultad_tecnologica.decano (
...
CREATE TABLE facultad_tecnologica.coordinador (
