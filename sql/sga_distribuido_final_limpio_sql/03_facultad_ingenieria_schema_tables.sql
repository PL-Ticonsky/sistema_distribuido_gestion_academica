...
CREATE TABLE facultad_ingenieria.administrativo (
...
CREATE TABLE facultad_ingenieria.programa_asignatura (
...
CREATE TABLE facultad_ingenieria.pre_requisito (
    ...
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_ingenieria.programa_asignatura(id_programa_asignatura,id_facultad),
    FOREIGN KEY(id_programa_asignatura_requisito,id_facultad) REFERENCES facultad_ingenieria.programa_asignatura(id_programa_asignatura,id_facultad)
);

CREATE TABLE facultad_ingenieria.grupo (
    ...
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_ingenieria.programa_asignatura(id_programa_asignatura,id_facultad),
    FOREIGN KEY(id_profesor) REFERENCES facultad_ingenieria.profesor(id_profesor)
);

CREATE TABLE facultad_ingenieria.matricula (
    ...
    FOREIGN KEY(id_estudiante) REFERENCES facultad_ingenieria.estudiante(id_estudiante)
);

CREATE TABLE facultad_ingenieria.inscripcion (
    ...
    FOREIGN KEY(id_grupo,id_facultad) REFERENCES facultad_ingenieria.grupo(id_grupo,id_facultad),
    FOREIGN KEY(id_estudiante) REFERENCES facultad_ingenieria.estudiante(id_estudiante)
);

CREATE TABLE facultad_ingenieria.homologacion (
    ...
    FOREIGN KEY(id_profesor_evaluador) REFERENCES facultad_ingenieria.profesor(id_profesor),
    FOREIGN KEY(id_estudiante) REFERENCES facultad_ingenieria.estudiante(id_estudiante),
    FOREIGN KEY(id_programa_asignatura,id_facultad) REFERENCES facultad_ingenieria.programa_asignatura(id_programa_asignatura,id_facultad)
);

CREATE TABLE facultad_ingenieria.decano (
...
CREATE TABLE facultad_ingenieria.coordinador (
